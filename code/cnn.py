...
class LeNetConvPoolLayer(object):
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2)):
        ...
        # param image_shape(tuple or list of length 4): (batch size, num input feature maps, image height, image width)
...
def evaluate_lenet5(learning_rate=0.1, n_epochs=50,
                    ...
                    nkerns=[12, 64], batch_size=500):

    #param n_epochs(int): maximal number of epochs to run the optimizer
   ...
   #build model
    ...
    # second convolutional pooling layer: filtering reduces the image size to (12-5+1, 12-5+1) = (8, 8)
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                print('in epoch %i, the validation error of training set is %f %%' %
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    # print(('in epoch %i, test error of '
                    #        'best model %f %%') %
                ...
                sheet1.write(epoch,1,test_score* 100.)
                sheet1.write(epoch,2,this_validation_loss * 100.)
